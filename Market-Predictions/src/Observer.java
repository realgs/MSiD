...
public class Observer {
    ...
    float fee = (float) 0.0005;
    String name;
    public Observer(float bidp, float askp, float bidq, float askq, String sname){
        bid_prize =bidp;
        ask_prize = askp;
        bid_quant = bidq;
        ask_quant = askq;
    ...
    static Observer getDataBitbay(String currency1, String currency2) throws IOException, ParseException {
        ...
        Observer ob1 = new Observer(bid_price, ask_price, bid_quant, ask_quant, "Bitbay");
        b_reader.close();
        return ob1;
    }
    static Observer getDataBittrex(String currency1, String currency2) throws IOException, ParseException {
        ...
        System.out.println("Bid= " + bid_price + "\t Quantity= " + bid_quant + "\t Ask = " + ask_price + "\t Quantitiy = " + ask_quant);
        Observer ob1 = new Observer(bid_price, ask_price, bid_quant, ask_quant, "Bittrex");
        b_reader.close();
        return ob1;
    }
    static Observer getDataBitstamp(String currency1, String currency2) throws IOException, ParseException {
        ...
        float ask_quant = Float.valueOf(ask.get(1).toString());
        System.out.println("Bid= " + bid_price + "\t Quantity= " + bid_quant + "\t Ask = " + ask_price + "\t Quantitiy = " + ask_quant);
        Observer ob1 = new Observer(bid_price, ask_price, bid_quant, ask_quant, "Bittstamp");
        b_reader.close();
        return ob1;
    }

    static Observer getDataBitfinex(String currency1, String currency2) throws IOException, ParseException {
        ...
        // double dif = 1 - ((ask_p - bid_p) / bid_p);
        System.out.println("Bid= " + bid_price + "\t Quantity= " + bid_quant + "\t Ask = " + ask_price + "\t Quantitiy = " + ask_quant);

        Observer ob1 = new Observer(bid_price, ask_price, bid_quant, ask_quant, "Bitfinex");
        b_reader.close();
        return ob1;
    }
}
